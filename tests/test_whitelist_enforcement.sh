...
reject "$HOME/Library/Application Support/Claude/Login Data"
reject "$HOME/Library/Application Support/Notion/Cookies"
reject "$HOME/Library/Group Containers/group.com.apple.notes/NoteStore.sqlite"
reject "$HOME/Library/Containers/com.tencent.xinWeChat/Data/Library/Application Support/com.tencent.xinWeChat/2.0b4.0.9/.../Message_full.sqlite"
