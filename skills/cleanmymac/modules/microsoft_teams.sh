MODULE_NAME="Microsoft Teams caches"
MODULE_DESCRIPTION="Microsoft Teams caches and logs (classic + new Teams)."
MODULE_RISK="low"
...
MODULE_PATHS=(
  ...
  "$HOME/Library/Application Support/Microsoft/Teams/Service Worker"
