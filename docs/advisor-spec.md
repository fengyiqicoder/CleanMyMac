...
A Smart Advisor heuristic is a shell file in `skills/cleanmymac/advisor-heuristics/` that surfaces deletion candidates beyond fixed cleanup modules.
...
1. Copy any existing file in `skills/cleanmymac/advisor-heuristics/` and adapt.
